...
<head>
    ...
    <link rel="stylesheet" href="{{asset('panel/vendors/vmap/jqvmap.min.css')}}" type="text/css">
    ...
    <link rel="stylesheet" href="{{asset('panel/plugins/ckeditor/ckeditor.js')}}" type="text/css">
