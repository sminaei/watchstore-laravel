                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{route('products.update',$product->id)}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea id="description" class="form-control" name="description"  rows="10" cols="20">
                                {{$product->description}}
                                </textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <label  class="col-form-label">تاریخ اعتبار فروش شگفت انگیز </label>
                            </div>
                            <div class="col-sm-6">
                                <input value="{{Hekmatinasser\Verta\Verta::instance($product->special_expiration)}}" type="text" id="special_expiration" class="form-control text-left"  dir="rtl" name="special_expiration">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" data-select2-id="23">
                            <label class="col-sm-2 col-form-label">برندها </label>
                            <div class="col-sm-10">
                                <select class="form-select" name="brand_id" style="width: 100%;" data-select2-id="2" tabindex="-2" aria-hidden="true">
                        ...
                        <div class="form-group row" data-select2-id="23">
                            ...
                            <div class="col-sm-10">
                                <select class="form-select" multiple="" name="colors[]" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                    @foreach($colors as $key=>$value)
                                        @if(in_array($key,$product->colors()->pluck('id')->toArray()))
                                        <option selected style="" value="{{$key}}">{{$value}}</option>
                                        @else
