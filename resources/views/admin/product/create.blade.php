                ...
                <div class="container">
                    ...
                    <form method="POST" action="{{route('products.store')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                             <textarea id="description" class="form-control" name="description"  rows="10" cols="20"></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="special_expiration" class="form-control text-left"  dir="rtl" name="special_expiration">
                            </div>
                        </div>
